...
function serveIndex(res){
  ...
  // بناء الشريط الإخباري داخل HTML نفسه (عرض ثابت كاحتياط؛ JavaScript يشغّل الحركة)
  let tickerHtml;
  if(news.length){
    ...
    tickerHtml=`<div class="news-ticker" id="newsTicker" style="display:flex"><span class="ticker-label">الأخبار</span><div class="ticker-viewport">${news.map(itemHTML).join("")}</div></div>`;
  } else {
