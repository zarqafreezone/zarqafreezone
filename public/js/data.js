    ...
    subs: [
      {
        ...
        name: "سيارات للبيع",
        icon: "🚙",
        types: ["سيدان", "هاتشباك", "دفع رباعي SUV", "كوبيه", "كابورليه (مكشوفة)", "فان / ميني فان", "بيك أب", "سيدان تنفيذية", "كهربائية (EV)", "هجينة", "كلاسيكية وقديمة (كلاسيك)", "معدّلة وسباق", "أخرى"],
        brands: ["تويوتا", "هيونداي", "كيا", "نيسان", "هوندا", "مازدا", "ميتسوبيشي", "سوزوكي", "سوبارو", "مرسيدس-بنز", "BMW", "أودي", "فولكس فاجن", "شيفروليه", "فورد", "جيب", "دودج", "جي إم سي", "كاديلاك", "لكزس", "إنفينيتي", "أكورا", "بورش", "فولفو", "لاند روفر", "جاكوار", "بيجو", "رينو", "ستروين", "فيات", "سكودا", "سيات", "تيسلا", "بي إي واي دي BYD", "جيلي", "تشيري", "MG", "هافال Haval", "تشانغان Changan", "جيتور Jetour", "GAC", "هونغ تشي Hongqi", "زيكر Zeekr", "لينك آند كو Lynk & Co", "شاوبنغ Xpeng", "نيو Nio", "لوسيد Lucid", "رولز رويس", "بنتلي", "لامبورغيني", "فيراري", "مازيراتي", "أستون مارتن", "جينيسيس Genesis", "تاتا", "ماهيندرا", "سانغ يونغ", "داسيا", "لادا", "أخرى"]
      },
      {
        id: "bikes",
        name: "دراجات نارية ومستلزمات",
        icon: "🏍️",
        types: ["دراجة نارية رياضية", "دراجة نارية كلاسيكية", "سكوتر", "دراجة رباعية (ATV)", "دباب (BUGGY)", "دراجة كهربائية", "خوذ وملابس دراجات", "ملحقات دراجات", "أخرى"],
      ...
      },
      {
        ...
        name: "مركبات للإيجار",
        icon: "🚕",
        types: ["سيارات للإيجار", "باصات للإيجار", "دراجات للإيجار", "آليات ثقيلة للإيجار", "قوارب وجت سكي للإيجار", "كرفانات للإيجار", "أخرى"],
        brands: ["أخرى"]
      },
      {
        id: "heavy",
        name: "آليات ثقيلة",
        icon: "🚜",
        types: ["حفارة (إكسكيفتر)", "بلدوزر", "جرافة", "لودر (شيولدر)", "كرين / رافعة متحركة", "قلاب (شاحنة قلابة كبيرة)", "مدحلة", "ممهدة الطرق (موتر جريدر)", "شاحنة خرسانة", "مضخة خرسانة", "خلاطة خرسانة", "شاحنة رصف", "شاحنة كشط", "ملحقات آليات البناء", "جرار زراعي", "حصادة", "آلة حرث", "رشاشة زراعية", "كمبوسر (دكاكة)", "حفارة مصغرة (ميني)", "أخرى"],
        brands: ["كاتربيلر", "كوماتسو", "هيتاشي", "فولفو CE", "ليبور", "جي سي بي JCB", "بوك لين", "دوسان", "ساني", "كوبيلكو", "بوب كات Bobcat", "جون دير", "ماساي فيرغسون", "نيوهولاند", "كوبوتا", "أخرى"]
      },
      {
        id: "commercial",
        name: "الحافلات والشاحنات والمقطورات",
        icon: "🚚",
        types: ["باصات ركاب", "حافلة متوسطة (كوستر)", "ميكروباص", "حافلة سياحية فاخرة", "صندوق", "تنك / صهريج", "شاحنة مبردة (براد)", "رأس تريلا", "ونش (سحب وإنقاذ)", "شاسيه", "شاحنة قلابة", "ناقلة سيارات", "سطحة", "شاحنة حاويات", "مقطورة حاويات", "مقطورة سيارات", "مقطورة صهريج", "مقطورة بضائع مسطحة", "مقطورة قلابة", "تيلر ثقيل (semi-trailer)", "كرفان (مقطورة إسكان)", "مقطورة صغيرة", "أخرى"],
        brands: ["مرسيدس-بنز", "فولفو", "مان MAN", "سكانيا", "رينو", "إيفيكو", "ميتسوبيشي فوسو", "إيسوزو", "هيونداي", "دايو", "كاماز", "تاترا", "ماك MAC", "بيتربيلت", "تويوتا (كوستر)", "كيا", "سترا", "Temsa", "شميتز", "كوغيل", "كراون", "أخرى"]
      },
      {
        id: "boats",
        name: "قوارب وجت سكي",
        icon: "🛥️",
        types: ["يخت فاخر", "قارب صيد", "قارب سريع (زورق)", "جت سكي", "كاياك", "قارب تجديف", "قارب مطاطي", "سفينة تجارية", "أخرى"],
        brands: ["أخرى"]
      },
      {
        id: "plates",
        name: "أرقام مركبات مميزة",
        icon: "🔢",
        types: ["أرقام لوحات سيارات", "أرقام لوحات دراجات", "أرقام لوحات شاحنات", "أرقام لوحات أخرى", "أخرى"],
        brands: ["أخرى"]
      },
      {
        id: "tires",
        name: "اطارات وجنطات",
        icon: "⭕",
        types: ["إطارات", "جنوط (رنجات)", "مجموعة جنوط وإطارات", "غطاء إطار", "أخرى"],
        brands: ["أخرى"]
      },
      {
        id: "spareparts",
        name: "قطع غيار المركبات",
        icon: "🔩",
        types: ["المحرك وقطعه", "ناقل الحركة (جير)", "نظام التعليق والتوجيه", "مكابح", "دفرنس وعجلات دفع", "كهرباء وبواجي ودينامو", "بطاريات", "شكمان وعادم", "فلاتر وزيوت", "كشتلات وبدي", "أنظمة تبريد", "أنظمة تعليق هوائي", "أخرى"],
...
const SEED_LISTINGS = [
  ...
  { id: "l3", deal: "sell", section: "vehicles", sub: "commercial",   type: "شاحنة مبردة (براد)", brand: "مرسيدس-بنز", model: "Actros", title: "شاحنة براد مرسيدس اكتروس 2020", price: 42000, currency: "USD", location: "المستودعات", images: 1, img: "images/truck1.jpg", user: "u1", date: "2026-08-10", featured: false, desc: "شاحنة تبريد بحالة ممتازة، جاهزة للعمل فوراً." },
