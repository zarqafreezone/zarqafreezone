...
const CATEGORIES = [
    ...
    subs: [
      ...
      },
      {
        ...
        icon: "🏍️",
        types: ["دراجة نارية رياضية", "دراجة نارية كلاسيكية", "سكوتر", "دراجة رباعية (ATV)", "دباب (BUGGY)", "دراجة كهربائية", "دراجة هوائية", "خوذ وملابس دراجات", "ملحقات دراجات", "أخرى"],
      ...
      },
      {
        ...
        icon: "🚜",
        types: ["حفارة (إكسكيفتر)", "بلدوزر", "جرافة", "لودر (شيولدر)", "كرين / رافعة متحركة", "قلاب (شاحنة قلابة كبيرة)", "مدحلة", "ممهدة الطرق (موتر جريدر)", "شاحنة خرسانة", "مضخة خرسانة", "خلاطة خرسانة", "شاحنة رصف", "فينشر (معدات مناجم)", "كمبوسر (دكاكة)", "حفارة مصغرة (ميني)", "ملحقات آليات البناء", "أخرى"],
      ...
      },
      {
        ...
        name: "آليات زراعية",
        icon: "🚜",
        types: ["جرار زراعي", "حصادة", "آلة حرث", "رشاشة زراعية", "بالير (حاطبة)", "مركبة عمل (UTV)", "أخرى"],
      ...
      },
      {
        ...
        name: "شاحنات",
        icon: "🚚",
        types: ["صندوق", "تنك / صهريج", "شاحنة مبردة (براد)", "رأس تريلا", "ونش (سحب وإنقاذ)", "شاسيه", "شاحنة قلابة", "ناقلة سيارات", "سطحة", "شاحنة حاويات", "أخرى"],
      ...
      },
      {
        ...
        name: "حافلات وباصات",
        icon: "🚌",
        types: ["باصات ركاب", "حافلة متوسطة (كوستر)", "ميكروباص", "حافلة سياحية فاخرة", "حافلة مدرسية", "ميني باص", "أخرى"],
      ...
      },
      {
        ...
        name: "مقطورات وتيلر",
        icon: "🚛",
        types: ["مقطورة حاويات", "مقطورة سيارات", "مقطورة صهريج", "مقطورة بضائع مسطحة", "مقطورة قلابة", "تيلر ثقيل (semi-trailer)", "كرفان (مقطورة إسكان)", "سطحة", "مقطورة صغيرة", "أخرى"],
        brands: ["شميتز", "كوغيل", "كراون", "أخرى"]
      },
      {
        id: "boats",
        name: "قوارب ويخوت وجت سكي",
        icon: "🛥️",
